...
Демо-версия публикуется на GitHub Pages: **https://avtanos.github.io/beton2**

- Сборка и публикация через GitHub Actions при push в `main`
- В настройках репозитория: **Settings → Pages → Source: GitHub Actions**
- Режим «только чтение»: данные загружаются из JSON без бэкенда
- Для работы с записью нужен локальный сервер (`npm run dev`)
